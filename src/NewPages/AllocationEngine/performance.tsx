  ...
  return (
    <div className="min-w-[280px] w-[100%] md:w-[47%] xl:w-[35%] bg-white rounded-xl border-2 overflow-x-auto">
        ...
        <div className="flex items-center gap-3">
            ...
            <div className="text-[13px] font-['calibri' !important]">Champion</div>
            </div>
            <div className="flex items-center gap-2">
            <div className="w-[25px] h-[10px] bg-[#A090D5] border rounded-xl"></div>
            <div className="text-[13px] font-['calibri' !important]">Challenger</div>
            </div>
        </div>
        </div>
    ...
    <RadarChart cx={300} cy={250} outerRadius={100} width={500} height={400} data={data} className="-mt-[100px] -ml-[90px]">
      <PolarGrid />
      <PolarAngleAxis dataKey="subject" tick={{ fontSize: 14, fill: '#000',fontFamily:'calibri', fontWeight:400 }} />
